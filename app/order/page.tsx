...
export default function OrderPage() {
  return (
    <>
      <section className="bg-china-red px-4 py-8 text-white sm:py-12">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="mt-3 max-w-2xl text-base leading-7 text-red-50 sm:text-lg sm:leading-8">Online ordering on this site is pickup only.</p>
        </div>
      </section>
      <DeliveryPlatforms />
      <MenuBrowser />
