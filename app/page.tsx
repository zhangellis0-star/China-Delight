  ...
  return (
    <>
      <section className="bg-[radial-gradient(circle_at_top_left,#f5b642_0%,#f5b642_10%,transparent_22%),linear-gradient(135deg,#0f5f56_0%,#2f8d7c_46%,#dff4f2_100%)] text-white">
        <div className="mx-auto grid max-w-7xl items-center gap-7 px-4 py-8 sm:px-6 sm:py-12 lg:min-h-[calc(100vh-88px)] lg:grid-cols-[1.05fr_.95fr] lg:gap-10 lg:px-8">
          <div>
            ...
            <p className="mt-4 max-w-xl text-base leading-7 text-teal-50 sm:mt-5 sm:text-xl sm:leading-8">
              Fresh Chinese favorites for pickup, take out, and dine in at Ledgbrook Plaza in Winsted.
            </p>
            <div className="mt-6 flex flex-col gap-3 sm:mt-8 sm:flex-row sm:items-center">
              <ButtonLink href="/order" className="min-h-14 bg-china-gold px-6 text-lg text-china-ink shadow-warm hover:bg-yellow-300 sm:min-h-16 sm:px-8 sm:text-xl">
                Start Your Order
              </ButtonLink>
            ...
            <p className="mt-3 text-base font-black text-china-gold sm:text-lg">Click Start Your Order to begin a pickup order now.</p>
            <div className="mt-6 grid gap-3 text-base font-bold sm:mt-8 sm:text-lg">
          ...
          <div className="rounded-lg border border-white/35 bg-[#f5fbf5] p-3 text-china-ink shadow-warm sm:p-5">
            <div className="rounded-md border border-china-green/50 bg-[linear-gradient(180deg,#dff4f2_0%,#fffaf0_100%)] p-4 sm:p-6">
              <div className="rounded-md border-4 border-double border-teal-700 bg-white/90 p-4 text-center sm:p-5">
                ...
                <h2 className="mt-4 text-2xl font-black text-teal-900 sm:mt-5 sm:text-4xl">Hot Chinese Food</h2>
      ...
      <section className="bg-[#f5fbf5]">
        ...
        <div className="flex flex-col justify-between gap-4 rounded-lg border border-china-green/35 bg-white/70 p-4 sm:flex-row sm:items-end">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-black text-china-ink sm:text-3xl">Customer favorites</h2>
          </div>
      ...
      <section className="bg-[linear-gradient(180deg,#f5fbf5,#dff4f2)]">
        <div className="mx-auto grid max-w-7xl gap-6 px-4 py-8 sm:px-6 sm:py-12 lg:grid-cols-2 lg:px-8">
          <div>
            <p className="font-black uppercase tracking-[0.16em] text-china-red">Hours</p>
            <h2 className="mt-2 text-2xl font-black sm:text-3xl">Open seven days</h2>
            <div className="mt-6 grid gap-3">
              {restaurant.hours.map((row) => (
                <div key={row.days} className="flex flex-wrap items-center justify-between gap-2 rounded-md border border-china-green/35 bg-white/85 p-3 sm:p-4">
          ...
          <div className="rounded-lg border border-china-green/40 bg-[#fffaf0] p-5 shadow-sm">
            ...
            <p className="mt-3 text-base leading-7 text-stone-700 sm:text-lg sm:leading-8">Order online for pickup, review your total, pay in store, and receive an order number.</p>
