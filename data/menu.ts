...
const rawMenuItems: MenuItem[] = [
  ...
  { id: "dumplings", number: "14", name: "Dumpling, Pan Fried or Steamed (8)", category: "Appetizers", prices: { order: 8.95 }, options: regularOptions },
  { id: "vegetable-dumplings", number: "15", name: "Vegetable Dumpling, Pan Fried or Steamed (8)", category: "Appetizers", prices: { order: 8.95 }, options: regularOptions },
  ...
  { id: "mini-pu-pu-platter", number: "16a", name: "Mini Pu Pu Platter", category: "Appetizers", prices: { order: 15.25 }, description: "Egg roll(1), Cheese Wonton(7), Teriyaki Chicken(2), golden finger(7).", options: regularOptions },
  ...
  { id: "roast-pork-broccoli", number: "62", name: "Roast Pork with Broccoli", category: "Roast Pork", description: "With white rice.", prices: { pint: 8.95, quart: 13.60, combo: 11.95 }, options: riceOptions },
  { id: "roast-pork-mixed-vegetables", number: "62a", name: "Roast Pork with Mixed Vegetables", category: "Roast Pork", description: "With white rice.", prices: { pint: 8.95, quart: 13.60, combo: 11.95 }, options: riceOptions },
  ...
  { id: "honey-chicken", number: "137b", name: "Honey Chicken", category: "Szechuan & Hunan Dishes", prices: { order: 13.85 }, options: riceOptions },
