...
const rawMenuItems: MenuItem[] = [
  ...
  { id: "teriyaki-beef", number: "8", name: "Teriyaki Beef (2)", chineseName: "照烧牛肉", category: "Appetizers", prices: { order: 6.75 }, options: regularOptions },
  { id: "bar-b-q-spare-ribs", number: "9", name: "Bar-B-Q Spare Ribs", chineseName: "叉烧排骨", category: "Appetizers", prices: { small: 9.85, large: 19.25 }, options: regularOptions, description: "With Bone" },
  { id: "boneless-spare-ribs", number: "11", name: "Boneless Spare Ribs", chineseName: "无骨排骨", category: "Appetizers", prices: { small: 9.85, large: 19.25 }, options: regularOptions },
  { id: "golden-finger-chicken", number: "12", name: "Golden Finger Chicken", chineseName: "黄金鸡柳", category: "Appetizers", prices: { order: 10.35 }, options: regularOptions },
  { id: "chicken-nugget", number: "12a", name: "Chicken Nugget", chineseName: "炸鸡块", category: "Appetizers", prices: { order: 7.25 }, options: regularOptions },
  { id: "fried-chicken-wings-(4pcs)", number: "13", name: "Fried Chicken Wings", chineseName: "炸鸡翅", category: "Appetizers", prices: { order: 7.25 }, options: regularOptions },
  { id: "dumplings", number: "14", name: "Dumpling, Pan Fried or Steamed (8)", chineseName: "煎饺或蒸饺", category: "Appetizers", prices: { order: 9.25 }, options: regularOptions },
  { id: "vegetable-dumplings", number: "15", name: "Vegetable Dumpling, Pan Fried or Steamed (8)", chineseName: "素菜煎饺或蒸饺", category: "Appetizers", prices: { order: 9.25 }, options: regularOptions },
  { id: "pu-pu-platter", number: "16", name: "Pu Pu Platter", chineseName: "什锦拼盘", category: "Appetizers", prices: { order: 16.55 }, description: "Egg roll(2), crab rangoon(2), golden finger(6), fantail shrimp(2), fried wonton(6), BBQ spare ribs(2), teriyaki beef(2).", options: regularOptions },
  { id: "mini-pu-pu-platter", number: "16a", name: "Mini Pu Pu Platter", chineseName: "迷你什锦拼盘", category: "Appetizers", prices: { order: 15.95 }, description: "Egg roll(1), Cheese Wonton(7), Teriyaki Chicken(2), golden finger(7).", options: regularOptions },
  { id: "cold-sesame-noodles", number: "17", name: "Cold Sesame Noodles", chineseName: "芝麻凉面", category: "Appetizers", spicy: true, prices: { order: 9.35 }, options: regularOptions },
  ...
  { id: "teriyaki-chicken", number: "20", name: "Teriyaki Chicken (3)", chineseName: "照烧鸡", category: "Appetizers", prices: { order: 6.80 }, options: regularOptions },
  ...
  { id: "chicken-noodle-soup", number: "23", name: "Chicken Noodle Soup", chineseName: "鸡肉面汤", category: "Soup", description: "With fried noodles.", prices: { pint: 4.65, quart: 7.45 }, options: regularOptions },
  { id: "chicken-rice-soup", number: "24", name: "Chicken Rice Soup", chineseName: "鸡肉饭汤", category: "Soup", description: "With fried noodles.", prices: { pint: 4.65, quart: 7.45 }, options: regularOptions },
  ...
  { id: "vegetable-soup", number: "26", name: "Vegetable Soup", chineseName: "蔬菜汤", category: "Soup", description: "With fried noodles.", prices: { pint: 5.60, quart: 8.50 }, options: regularOptions },
  ...
  { id: "house-special-soup", number: "28", name: "House Special Soup", chineseName: "本楼例汤", category: "Soup", description: "With fried noodles.", prices: { quart: 8.50 }, options: regularOptions },
  ...
  { id: "chicken-fried-rice", number: "32", name: "Chicken Fried Rice", chineseName: "鸡肉炒饭", category: "Fried Rice", prices: { pint: 6.95, quart: 10.50 }, options: regularOptions },
  { id: "shrimp-fried-rice", number: "33", name: "Shrimp Fried Rice", chineseName: "虾仁炒饭", category: "Fried Rice", prices: { pint: 6.95, quart: 11.40 }, options: regularOptions },
  { id: "beef-fried-rice", number: "34", name: "Beef Fried Rice", chineseName: "牛肉炒饭", category: "Fried Rice", prices: { pint: 6.95, quart: 11.40 }, options: regularOptions },
  { id: "vegetable-fried-rice", number: "35", name: "Vegetable Fried Rice", chineseName: "素菜炒饭", category: "Fried Rice", prices: { pint: 6.95, quart: 10.50 }, options: regularOptions },
  ...
  { id: "plain-fried-rice", number: "37", name: "Plain Fried Rice", chineseName: "白炒饭", category: "Fried Rice", prices: { pint: 6.20, quart: 10.50 }, options: regularOptions },
  ...
  { id: "chicken-lo-mein", number: "40", name: "Chicken Lo Mein", chineseName: "鸡肉捞面", category: "Lo Mein", description: "Soft noodles.", prices: { pint: 8.85, quart: 11.75, combo: 11.75 }, options: regularOptions },
  { id: "shrimp-lo-mein", number: "41", name: "Shrimp Lo Mein", chineseName: "虾仁捞面", category: "Lo Mein", description: "Soft noodles.", prices: { pint: 8.85, quart: 11.75, combo: 11.75 }, options: regularOptions },
  { id: "beef-lo-mein", number: "42", name: "Beef Lo Mein", chineseName: "牛肉捞面", category: "Lo Mein", description: "Soft noodles.", prices: { pint: 8.85, quart: 11.75, combo: 11.75 }, options: regularOptions },
  { id: "vegetable-lo-mein", number: "43", name: "Vegetable Lo Mein", chineseName: "素菜捞面", category: "Lo Mein", description: "Soft noodles.", prices: { pint: 8.85, quart: 11.75, combo: 11.75 }, options: regularOptions },
  { id: "plain-lo-mein", number: "43a", name: "Plain Lo Mein", chineseName: "白捞面", category: "Lo Mein", description: "Soft noodles.", prices: { pint: 8.85, quart: 11.75 }, options: regularOptions },
  ...
  { id: "roast-pork-chinese-vegetables", number: "59", name: "Roast Pork with Chinese Vegetables", chineseName: "叉烧炒时蔬", category: "Roast Pork", description: "With white rice.", prices: { pint: 9.55, quart: 13.95, combo: 12.35 }, options: riceOptions },
  ...
  { id: "roast-pork-broccoli", number: "62", name: "Roast Pork with Broccoli", chineseName: "西兰花叉烧", category: "Roast Pork", description: "With white rice.", prices: { pint: 9.55, quart: 13.95, combo: 12.35 }, options: riceOptions },
  { id: "roast-pork-mixed-vegetables", number: "62a", name: "Roast Pork with Mixed Vegetables", chineseName: "什锦叉烧", category: "Roast Pork", description: "With white rice.", prices: { pint: 9.55, quart: 13.95, combo: 12.35 }, options: riceOptions },
  ...
  { id: "beef-broccoli", number: "68", name: "Beef with Broccoli", chineseName: "西兰花牛肉", category: "Beef", description: "With white rice.", prices: { pint: 9.80, quart: 14.20, combo: 12.60 }, options: riceOptions },
  { id: "curry-beef-onion", number: "69", name: "Curry Beef with Onion", chineseName: "咖喱牛肉", category: "Beef", spicy: true, description: "With white rice.", prices: { pint: 9.80, quart: 14.20, combo: 12.60 }, options: riceOptions },
  { id: "beef-mixed-vegetables", number: "69a", name: "Beef with Mixed Vegetables", chineseName: "什锦牛肉", category: "Beef", description: "With white rice.", prices: { pint: 9.80, quart: 14.20, combo: 12.60 }, options: riceOptions },
  ...
  { id: "chicken-mixed-vegetables", number: "76", name: "Chicken with Mixed Vegetables", chineseName: "什锦鸡", category: "Chicken", description: "With white rice.", prices: { pint: 9.55, quart: 13.95, combo: 12.35 }, options: riceOptions },
  { id: "chicken-broccoli", number: "77", name: "Chicken with Broccoli", chineseName: "西兰花鸡", category: "Chicken", description: "With white rice.", prices: { pint: 9.55, quart: 13.95, combo: 12.35 }, options: riceOptions },
  ...
  { id: "sweet-sour-pork", number: "90", name: "Sweet & Sour Pork", chineseName: "糖醋肉", category: "Sweet & Sour", description: "With white rice.", prices: { pint: 9.45, quart: 12.35, combo: 12.45 }, options: riceOptions },
  { id: "sweet-sour-chicken", number: "91", name: "Sweet & Sour Chicken", chineseName: "糖醋鸡", category: "Sweet & Sour", description: "With white rice.", prices: { pint: 9.45, quart: 12.35, combo: 12.45 }, options: riceOptions },
  { id: "sweet-sour-shrimp", number: "92", name: "Sweet & Sour Shrimp", chineseName: "糖醋虾仁", category: "Sweet & Sour", description: "With white rice.", prices: { pint: 9.45, quart: 12.35, combo: 12.45 }, options: riceOptions },
  { id: "sweet-sour-triple", number: "93", name: "Sweet & Sour Triple", chineseName: "糖醋三鲜", category: "Sweet & Sour", description: "Chicken, pork, shrimp. Per order.", prices: { order: 13.45 }, options: riceOptions },

  { id: "roast-pork-egg-foo-young", number: "94", name: "Roast Pork Egg Foo Young", chineseName: "叉烧芙蓉蛋", category: "Egg Foo Young", description: "With white rice.", prices: { order: 11.95, combo: 11.95 }, options: riceOptions },
  { id: "chicken-egg-foo-young", number: "95", name: "Chicken Egg Foo Young", chineseName: "鸡肉芙蓉蛋", category: "Egg Foo Young", description: "With white rice.", prices: { order: 11.95, combo: 11.95 }, options: riceOptions },
  { id: "shrimp-egg-foo-young", number: "96", name: "Shrimp Egg Foo Young or Beef", chineseName: "虾仁或牛肉芙蓉蛋", category: "Egg Foo Young", description: "With white rice.", prices: { order: 11.95, combo: 11.95 }, options: riceOptions },
  { id: "mushroom-egg-foo-young", number: "97", name: "Mushroom Egg Foo Young", chineseName: "蘑菇芙蓉蛋", category: "Egg Foo Young", description: "With white rice.", prices: { order: 11.95, combo: 11.95 }, options: riceOptions },
  { id: "house-special-egg-foo-young", number: "97a", name: "House Special Egg Foo Young", chineseName: "本楼芙蓉蛋", category: "Egg Foo Young", description: "With white rice.", prices: { order: 11.95, combo: 11.95 }, options: riceOptions },
  { id: "vegetable-egg-foo-young", number: "98", name: "Vegetable Egg Foo Young", chineseName: "素菜芙蓉蛋", category: "Egg Foo Young", description: "With white rice.", prices: { order: 11.95, combo: 11.95 }, options: riceOptions },
  ...
  { id: "tofu-broccoli", number: "99a", name: "Tofu with Broccoli", chineseName: "西兰花豆腐", category: "Vegetable", description: "With white rice.", prices: { order: 12.35 }, options: riceOptions },
  ...
  { id: "eggplant-garlic-sauce", number: "100a", name: "Eggplant & Broccoli with Garlic Sauce", chineseName: "鱼香茄子西兰花", category: "Vegetable", spicy: true, description: "With white rice.", prices: { order: 12.35 }, options: riceOptions },
  { id: "tofu-mixed-vegetables", number: "101", name: "Tofu with Mixed Vegetables", chineseName: "什锦豆腐", category: "Vegetable", description: "With white rice.", prices: { order: 12.35 }, options: riceOptions },
  { id: "broccoli-garlic-sauce", number: "102", name: "Broccoli with Garlic Sauce", chineseName: "鱼香西兰花", category: "Vegetable", spicy: true, description: "With white rice.", prices: { order: 12.35 }, options: riceOptions },
  ...
  { id: "string-beans-broccoli-garlic", number: "103a", name: "String Beans & Broccoli in Garlic Sauce", chineseName: "鱼香四季豆西兰花", category: "Vegetable", spicy: true, description: "With white rice.", prices: { order: 12.35 }, options: riceOptions },

  { id: "chicken-chow-fun", number: "104", name: "Chicken Chow Fun or Mai Fun", chineseName: "鸡肉炒河粉或炒米粉", category: "Chow Fun/Mai Fun", prices: { order: 12.45 }, options: regularOptions },
  { id: "pork-chow-fun", number: "105", name: "Pork Chow Fun or Mai Fun", chineseName: "猪肉炒河粉或炒米粉", category: "Chow Fun/Mai Fun", prices: { order: 12.45 }, options: regularOptions },
  { id: "shrimp-chow-fun", number: "106", name: "Shrimp Chow Fun or Mai Fun", chineseName: "虾仁炒河粉或炒米粉", category: "Chow Fun/Mai Fun", prices: { order: 12.45 }, options: regularOptions },
   { id: "beef-chow-fun", number: "106a", name: "Beef Chow Fun or Mai Fun", chineseName: "牛肉炒河粉或炒米粉", category: "Chow Fun/Mai Fun", prices: { order: 12.45 }, options: regularOptions },
  { id: "singapore-chow-mai-fun", number: "107", name: "Singapore Chow Fun or Mai Fun", chineseName: "星洲炒河粉或炒米粉", category: "Chow Fun/Mai Fun", spicy: true, prices: { order: 13.20 }, options: regularOptions },
  { id: "vegetable-chow-fun", number: "107a", name: "Vegetable Chow Fun or Mai Fun", chineseName: "素菜炒河粉或炒米粉", category: "Chow Fun/Mai Fun", prices: { order: 12.45 }, options: regularOptions },
  { id: "house-special-chow-fun", number: "107b", name: "House Special Mai Fun", chineseName: "本楼炒米粉", category: "Chow Fun/Mai Fun", prices: { order: 13.20 }, options: regularOptions },
  ...
  { id: "moo-shu-shrimp-beef", number: "113", name: "Moo Shu Shrimp or Beef", chineseName: "木须虾仁或木须牛肉", category: "Szechuan & Hunan Dishes", description: "With white rice except moo shu dishes.", prices: { order: 12.95 }, options: riceOptions },
  ...
  { id: "shrimp-string-bean", number: "116", name: "Shrimp with String Bean", chineseName: "四季豆虾仁", category: "Szechuan & Hunan Dishes", prices: { order: 13.85 }, options: riceOptions },
  ...
  { id: "sesame-beef", number: "118", name: "Sesame Beef", chineseName: "芝麻牛肉", category: "Szechuan & Hunan Dishes", prices: { order: 14.70 }, options: riceOptions },
  { id: "sesame-shrimp", number: "119", name: "Sesame Shrimp", chineseName: "芝麻虾仁", category: "Szechuan & Hunan Dishes", prices: { order: 14.70 }, options: riceOptions },
  { id: "beef-szechuan-style", number: "120", name: "Beef Szechuan Style", chineseName: "四川牛肉", category: "Szechuan & Hunan Dishes", spicy: true, prices: { order: 13.95 }, options: riceOptions },
  ...
  { id: "hunan-beef", number: "122", name: "Hunan Beef", chineseName: "湖南牛肉", category: "Szechuan & Hunan Dishes", spicy: true, prices: { order: 13.95 }, options: riceOptions },
  ...
  { id: "beef-garlic-sauce", number: "125", name: "Beef with Garlic Sauce", chineseName: "鱼香牛肉", category: "Szechuan & Hunan Dishes", spicy: true, prices: { order: 13.95 }, options: riceOptions },
  { id: "shrimp-garlic-sauce", number: "126", name: "Shrimp with Garlic Sauce", chineseName: "鱼香虾仁", category: "Szechuan & Hunan Dishes", spicy: true, prices: { order: 14.20 }, options: riceOptions },
  ...
  { id: "kung-po-shrimp", number: "128", name: "Kung Po Shrimp with Peanuts", chineseName: "宫保虾仁", category: "Szechuan & Hunan Dishes", spicy: true, prices: { order: 13.95 }, options: riceOptions },
  { id: "shrimp-chicken-garlic", number: "129", name: "Shrimp & Chicken in Garlic Sauce", chineseName: "鱼香虾仁鸡", category: "Szechuan & Hunan Dishes", spicy: true, prices: { order: 13.95 }, options: riceOptions },
  ...
  { id: "shrimp-szechuan-style", number: "132", name: "Shrimp Szechuan Style", chineseName: "四川虾仁", category: "Szechuan & Hunan Dishes", spicy: true, prices: { order: 13.95 }, options: riceOptions },
  { id: "shrimp-chicken-hunan", number: "133", name: "Shrimp & Chicken Hunan Style", chineseName: "湖南虾仁鸡", category: "Szechuan & Hunan Dishes", spicy: true, prices: { order: 13.95 }, options: riceOptions },
  ...
  { id: "honey-chicken", number: "137b", name: "Honey Chicken", chineseName: "蜜糖鸡", category: "Szechuan & Hunan Dishes", prices: { order: 14.70 }, options: riceOptions },
  ...
  { id: "combo-sesame-shrimp", number: "C4", name: "Sesame Shrimp", chineseName: "芝麻虾仁", category: "Special Combination Platters", description: "Each plate served with egg roll and pork fried rice.", prices: { combo: 12.60 }, options: comboOptions },
  { id: "combo-golden-finger-teriyaki-chicken", number: "C5", name: "Golden Finger & Teriyaki Chicken", chineseName: "黄金鸡柳照烧鸡", category: "Special Combination Platters", description: "Each plate served with egg roll and pork fried rice.", prices: { combo: 12.35 }, options: comboOptions },
  { id: "combo-golden-finger-teriyaki-beef", number: "C6", name: "Golden Finger & Teriyaki Beef", chineseName: "黄金鸡柳照烧牛肉", category: "Special Combination Platters", description: "Each plate served with egg roll and pork fried rice.", prices: { combo: 12.60 }, options: comboOptions },
  { id: "combo-chicken-shrimp-combo", number: "C6a", name: "Chicken and Shrimp Combination", chineseName: "鸡肉虾仁双拼", category: "Special Combination Platters", description: "Each plate served with egg roll and pork fried rice.", prices: { combo: 12.35 }, options: comboOptions },
  { id: "combo-chicken-garlic-pork", number: "C7", name: "Chicken with Garlic Sauce or Pork", chineseName: "鱼香鸡或鱼香猪肉", category: "Special Combination Platters", description: "Each plate served with egg roll and pork fried rice.", spicy: true, prices: { combo: 12.35 }, options: comboOptions },
  { id: "combo-shrimp-garlic-beef", number: "C8", name: "Shrimp with Garlic Sauce or Beef", chineseName: "鱼香虾仁或鱼香牛肉", category: "Special Combination Platters", description: "Each plate served with egg roll and pork fried rice.", spicy: true, prices: { combo: 12.35 }, options: comboOptions },
  ...
  { id: "combo-hunan-beef-chicken", number: "C10", name: "Hunan Beef or Chicken", chineseName: "湖南牛肉或湖南鸡", category: "Special Combination Platters", description: "Each plate served with egg roll and pork fried rice.", spicy: true, prices: { combo: 12.35 }, options: comboOptions },
  ...
  { id: "combo-string-beans-garlic", number: "C12", name: "String Beans with Chicken or Shrimp in Garlic Sauce", chineseName: "鱼香四季豆鸡或虾仁", category: "Special Combination Platters", description: "Each plate served with egg roll and pork fried rice.", spicy: true, prices: { combo: 12.35 }, options: comboOptions },
  ...
  { id: "combo-eggplant-garlic", number: "C14", name: "Eggplant with Chicken or Shrimp in Garlic Sauce", chineseName: "鱼香茄子鸡或虾仁", category: "Special Combination Platters", description: "Each plate served with egg roll and pork fried rice.", spicy: true, prices: { combo: 12.35 }, options: comboOptions },
  { id: "combo-honey-chicken", number: "C15", name: "Honey Chicken", chineseName: "蜜糖鸡", category: "Special Combination Platters", description: "Each plate served with egg roll and pork fried rice.", prices: { combo: 12.35 }, options: comboOptions },
  { id: "combo-sauteed-broccoli", number: "C16", name: "Sauteed Broccoli", chineseName: "炒西兰花", category: "Special Combination Platters", description: "Each plate served with egg roll and pork fried rice.", prices: { combo: 12.35 }, options: comboOptions },
  { id: "combo-tofu-mixed-vegetables", number: "C17", name: "Tofu with Mixed Vegetables", chineseName: "什锦豆腐", category: "Special Combination Platters", description: "Each plate served with egg roll and pork fried rice.", prices: { combo: 12.35 }, options: comboOptions },
  { id: "combo-chicken-finger", number: "C18", name: "Chicken Finger", chineseName: "鸡柳", category: "Special Combination Platters", description: "Each plate served with egg roll and pork fried rice.", prices: { combo: 12.35 }, options: comboOptions },
  { id: "combo-coconut-shrimp", number: "C19", name: "Coconut Shrimp", chineseName: "椰香虾仁", category: "Special Combination Platters", description: "Each plate served with egg roll and pork fried rice.", prices: { combo: 12.50 }, options: comboOptions },

  { id: "seafood-combination", number: "138", name: "Seafood Combination", chineseName: "海鲜总会", category: "Chef Specials", description: "Lobster chunks, crabmeat, jumbo shrimp, scallops, sauteed with assorted Chinese vegetables.", prices: { order: 18.20 }, options: riceOptions },
  ...
  { id: "four-seasons", number: "140", name: "Four Seasons", chineseName: "四季总会", category: "Chef Specials", description: "Shrimp, beef, chicken, roast pork with broccoli, snow peas and water chestnuts.", prices: { order: 15.70 }, options: riceOptions },
  ...
  { id: "seven-stars-around-moon", number: "146", name: "Seven Stars Around the Moon (For 2)", chineseName: "七星伴月", category: "Chef Specials", description: "Chicken, beef, roast pork, scallops and crabmeat with all season vegetables topped with seven fantail shrimp.", prices: { order: 22.50 }, options: riceOptions },
  { id: "hawaii-delight", number: "147", name: "Hawaii Delight", chineseName: "夏威夷小炒", category: "Chef Specials", description: "Mixed of beef, chicken, jumbo shrimp and roast pork with mixed vegetables in chef's special brown sauce.", prices: { order: 15.20 }, options: riceOptions },
  ...
  { id: "crispy-orange-beef", number: "151", name: "Crispy Orange Flavor Beef", chineseName: "陈皮牛肉", category: "Chef Specials", spicy: true, prices: { order: 14.70 }, options: riceOptions },
  ...
  { id: "dragon-phoenix", number: "153", name: "Dragon & Phoenix", chineseName: "龙凤呈祥", category: "Chef Specials", description: "Spicy stir-fried jumbo shrimp and General Tso's chicken.", spicy: true, prices: { order: 16.20 }, options: riceOptions },
  { id: "shrimp-scallop-garlic", number: "154", name: "Shrimp & Scallop in Garlic Sauce", chineseName: "鱼香虾仁带子", category: "Chef Specials", spicy: true, prices: { order: 16.20 }, options: riceOptions },
  { id: "mongolian-beef-chicken", number: "155", name: "Mongolian Beef or Chicken", chineseName: "蒙古牛肉或蒙古鸡", category: "Chef Specials", description: "Snow peas, scallion, onion, sliced green pepper, beef with special spicy sauce.", spicy: true, prices: { order: 14.30 }, options: riceOptions },
  { id: "china-delight-chef", number: "156", name: "China Delight", chineseName: "本楼小炒", category: "Chef Specials", description: "Fresh scallop, chicken, jumbo shrimp, broccoli, dry mushroom in garlic sauce.", spicy: true, prices: { order: 15.70 }, options: riceOptions },
  { id: "coconut-shrimp-or-chicken", number: "158", name: "Coconut Shrimp or Chicken", chineseName: "椰香虾仁或椰香鸡", category: "Chef Specials", prices: { order: 15.80 }, options: riceOptions },
  ...
  { id: "diet-mixed-vegetables", number: "D1", name: "Mixed Chinese Vegetables", chineseName: "清蒸什锦时蔬", category: "Diet Food / Steamed", description: "With white rice and sauce on the side.", prices: { pint: 9.45, large: 13.95 }, options: riceOptions },
  { id: "diet-chicken-mixed-vegetables", number: "D2", name: "Chicken with Mixed Vegetables", chineseName: "清蒸什锦鸡", category: "Diet Food / Steamed", description: "With white rice and sauce on the side.", prices: { pint: 9.45, large: 13.95 }, options: riceOptions },
  { id: "diet-chicken-broccoli", number: "D3", name: "Chicken with Broccoli", chineseName: "清蒸西兰花鸡", category: "Diet Food / Steamed", description: "With white rice and sauce on the side.", prices: { pint: 9.45, large: 13.95 }, options: riceOptions },
  { id: "diet-shrimp-broccoli", number: "D4", name: "Shrimp with Broccoli", chineseName: "清蒸西兰花虾仁", category: "Diet Food / Steamed", description: "With white rice and sauce on the side.", prices: { pint: 9.85, large: 13.95 }, options: riceOptions },
  ...
  { id: "diet-string-bean", number: "D6", name: "String Bean Chicken or Shrimp", chineseName: "清蒸四季豆鸡或虾仁", category: "Diet Food / Steamed", description: "With white rice and sauce on the side.", prices: { pint: 8.95, large: 13.95 }, options: riceOptions },
...
const menuItemSplits: Record<string, MenuSplit[]> = {
  "egg-roll": [
    ...
    { id: "vegetable-egg-roll", number: "1B", name: "Vegetable Egg Roll", chineseName: "素菜蛋卷" }
  ],
  "shrimp-roll": [
  ...
  "crab-rangoon": [
    ...
    { id: "cheese-wonton", number: "6B", name: "Cheese Wonton", chineseName: "芝士云吞" }
  ],
  dumplings: [
    { id: "fried-dumplings", number: "14A", name: "Fried Dumpling (8)", chineseName: "煎饺" },
    { id: "steamed-dumplings", number: "14B", name: "Steamed Dumpling (8)", chineseName: "蒸饺" }
  ],
  "vegetable-dumplings": [
    { id: "fried-vegetable-dumplings", number: "15A", name: "Fried Vegetable Dumpling (8)", chineseName: "素菜煎饺" },
    { id: "steamed-vegetable-dumplings", number: "15B", name: "Steamed Vegetable Dumpling (8)", chineseName: "素菜蒸饺" }
  ],
  "shrimp-egg-foo-young": [
    { id: "shrimp-egg-foo-young", number: "96A", name: "Shrimp Egg Foo Young", chineseName: "虾仁芙蓉蛋" },
    { id: "beef-egg-foo-young", number: "96B", name: "Beef Egg Foo Young", chineseName: "牛肉芙蓉蛋" }
  ],
  "sauteed-broccoli": [
    { id: "sauteed-broccoli", number: "99A", name: "Sauteed Broccoli", chineseName: "炒西兰花" },
    { id: "buddhist-delight-vegetable", number: "99B", name: "Buddhist Delight", chineseName: "罗汉斋" }
  ],
  "chicken-chow-fun": [
    { id: "chicken-chow-fun", number: "104A", name: "Chicken Chow Fun", chineseName: "鸡肉炒河粉" },
    { id: "chicken-mai-fun", number: "104B", name: "Chicken Mai Fun", chineseName: "鸡肉炒米粉" }
  ],
  "pork-chow-fun": [
    { id: "pork-chow-fun", number: "105A", name: "Pork Chow Fun", chineseName: "猪肉炒河粉" },
    { id: "pork-mai-fun", number: "105B", name: "Pork Mai Fun", chineseName: "猪肉炒米粉" }
  ],
  "shrimp-chow-fun": [
    { id: "shrimp-chow-fun", number: "106A", name: "Shrimp Chow Fun", chineseName: "虾仁炒河粉" },
    { id: "shrimp-mai-fun", number: "106B", name: "Shrimp Mai Fun", chineseName: "虾仁炒米粉" }
  ],
  "singapore-chow-mai-fun": [
    { id: "singapore-chow-fun", number: "107A", name: "Singapore Chow Fun", chineseName: "星洲炒河粉" },
    { id: "singapore-mai-fun", number: "107B", name: "Singapore Mai Fun", chineseName: "星洲炒米粉" }
  ],
  "vegetable-chow-fun": [
    { id: "vegetable-chow-fun", number: "107C", name: "Vegetable Chow Fun", chineseName: "素菜炒河粉" },
    { id: "vegetable-mai-fun", number: "107D", name: "Vegetable Mai Fun", chineseName: "素菜炒米粉" }
  ],
  "wings-shrimp-fried-rice": [
    { id: "wings-shrimp-fried-rice", number: "110A", name: "Chicken Wings with Shrimp Fried Rice", chineseName: "鸡翅虾仁炒饭" },
    { id: "wings-beef-fried-rice", number: "110B", name: "Chicken Wings with Beef Fried Rice", chineseName: "鸡翅牛肉炒饭" }
  ],
  ...
  "moo-shu-shrimp-beef": [
    { id: "moo-shu-shrimp", number: "113A", name: "Moo Shu Shrimp", chineseName: "木须虾仁" },
    { id: "moo-shu-beef", number: "113B", name: "Moo Shu Beef", chineseName: "木须牛肉" }
  ],
  "combo-bbq-ribs": [
    { id: "combo-bbq-ribs", number: "C1A", name: "Bar-B-Q Spare Ribs", chineseName: "叉烧排骨" },
    { id: "combo-boneless-spare-ribs", number: "C1B", name: "Boneless Spare Ribs", chineseName: "无骨排骨" }
  ],
  "combo-chicken-garlic-pork": [
    { id: "combo-chicken-garlic-sauce", number: "C7A", name: "Chicken with Garlic Sauce", chineseName: "鱼香鸡" },
    { id: "combo-pork-garlic-sauce", number: "C7B", name: "Pork with Garlic Sauce", chineseName: "鱼香猪肉" }
  ],
  "combo-shrimp-garlic-beef": [
    { id: "combo-shrimp-garlic-sauce", number: "C8A", name: "Shrimp with Garlic Sauce", chineseName: "鱼香虾仁" },
    { id: "combo-beef-garlic-sauce", number: "C8B", name: "Beef with Garlic Sauce", chineseName: "鱼香牛肉" }
  ],
  "combo-hunan-beef-chicken": [
    { id: "combo-hunan-beef", number: "C10A", name: "Hunan Beef", chineseName: "湖南牛肉" },
  ...
  "combo-string-beans-garlic": [
    ...
    { id: "combo-string-beans-shrimp-garlic", number: "C12B", name: "String Beans with Shrimp in Garlic Sauce", chineseName: "鱼香四季豆虾仁" }
  ],
  "combo-eggplant-garlic": [
    ...
    { id: "combo-eggplant-shrimp-garlic", number: "C14B", name: "Eggplant with Shrimp in Garlic Sauce", chineseName: "鱼香茄子虾仁" }
  ],
  "mongolian-beef-chicken": [
    { id: "mongolian-beef", number: "155A", name: "Mongolian Beef", chineseName: "蒙古牛肉" },
    { id: "mongolian-chicken", number: "155B", name: "Mongolian Chicken", chineseName: "蒙古鸡" }
  ],
  "coconut-shrimp-or-chicken": [
    { id: "coconut-shrimp-chef", number: "158A", name: "Coconut Shrimp", chineseName: "椰香虾仁" },
  ...
  "diet-string-bean": [
    ...
    { id: "diet-string-bean-shrimp", number: "D6B", name: "String Bean Shrimp", chineseName: "清蒸四季豆虾仁" }
  ],
  "lunch-string-bean-chicken-shrimp": [
    { id: "lunch-string-bean-chicken", number: "LD5A", name: "String Bean Chicken", chineseName: "四季豆鸡" },
    { id: "lunch-string-bean-shrimp", number: "LD5B", name: "String Bean Shrimp", chineseName: "四季豆虾仁" }
  ],
  "lunch-beef-chicken-broccoli": [
    { id: "lunch-beef-broccoli", number: "L3A", name: "Beef with Broccoli", chineseName: "西兰花牛肉" },
