...
const comboOptions = { spiceLevel: true, rice: true, addOns: true, size: ["combo" as const] };
...
export const menuItems: MenuItem[] = [
  ...
  { id: "lunch-mixed-vegetables", number: "LD1", name: "Mixed Chinese Vegetables", category: "Lunch Special", description: "Served with pork fried rice. Choice of wonton soup, egg drop soup, egg roll, or canned soda.", prices: { order: 9.45 }, options: comboOptions },
  { id: "lunch-chicken-mixed-vegetables", number: "LD2", name: "Chicken with Mixed Vegetables", category: "Lunch Special", description: "Served with pork fried rice. Choice of wonton soup, egg drop soup, egg roll, or canned soda.", prices: { order: 9.75 }, options: comboOptions },
  { id: "lunch-shrimp-broccoli", number: "LD3", name: "Shrimp with Broccoli", category: "Lunch Special", description: "Served with pork fried rice. Choice of wonton soup, egg drop soup, egg roll, or canned soda.", prices: { order: 9.75 }, options: comboOptions },
  { id: "lunch-chicken-broccoli", number: "LD4", name: "Chicken with Broccoli", category: "Lunch Special", description: "Served with pork fried rice. Choice of wonton soup, egg drop soup, egg roll, or canned soda.", prices: { order: 9.75 }, options: comboOptions },
  { id: "lunch-string-bean-chicken-shrimp", number: "LD5", name: "String Bean Chicken or Shrimp", category: "Lunch Special", description: "Served with pork fried rice. Choice of wonton soup, egg drop soup, egg roll, or canned soda.", prices: { order: 9.75 }, options: comboOptions },
  { id: "lunch-shrimp-chow-mein", number: "L1", name: "Shrimp Chow Mein", category: "Lunch Special", description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 9.75 }, options: comboOptions },
  { id: "lunch-chicken-chow-mein", number: "L2", name: "Chicken Chow Mein", category: "Lunch Special", description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 9.45 }, options: comboOptions },
  { id: "lunch-beef-chicken-broccoli", number: "L3", name: "Beef or Chicken with Broccoli", category: "Lunch Special", description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 9.75 }, options: comboOptions },
  { id: "lunch-roast-pork-chinese-vegetables", number: "L4", name: "Roast Pork with Chinese Vegetables", category: "Lunch Special", description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 9.45 }, options: comboOptions },
  { id: "lunch-pepper-steak-onion", number: "L5", name: "Pepper Steak with Onion", category: "Lunch Special", description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 9.75 }, options: comboOptions },
  { id: "lunch-shrimp-lobster-sauce", number: "L6", name: "Shrimp with Lobster Sauce", category: "Lunch Special", description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 9.75 }, options: comboOptions },
  { id: "lunch-moo-goo-gai-pan", number: "L7", name: "Moo Goo Gai Pan", category: "Lunch Special", description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 9.45 }, options: comboOptions },
  { id: "lunch-shrimp-chicken-lo-mein", number: "L8", name: "Shrimp or Chicken Lo Mein", category: "Lunch Special", description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 9.45 }, options: comboOptions },
  { id: "lunch-beef-chicken-garlic", number: "L9", name: "Beef or Chicken with Garlic Sauce", category: "Lunch Special", spicy: true, description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 9.75 }, options: comboOptions },
  { id: "lunch-boneless-spare-ribs", number: "L10", name: "Boneless Spare Ribs", category: "Lunch Special", description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 9.75 }, options: comboOptions },
  { id: "lunch-sweet-sour-pork-chicken", number: "L11", name: "Sweet & Sour Pork or Chicken", category: "Lunch Special", description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 9.75 }, options: comboOptions },
  { id: "lunch-roast-pork-lo-mein", number: "L12", name: "Roast Pork Lo Mein", category: "Lunch Special", description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 9.75 }, options: comboOptions },
  { id: "lunch-roast-pork-broccoli", number: "L13", name: "Roast Pork with Broccoli", category: "Lunch Special", description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 9.75 }, options: comboOptions },
  { id: "lunch-chicken-cashew", number: "L14", name: "Chicken with Cashew Nuts", category: "Lunch Special", description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 9.75 }, options: comboOptions },
  { id: "lunch-chicken-roast-pork-broccoli", number: "L14a", name: "Chicken or Roast Pork with Broccoli", category: "Lunch Special", description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 9.45 }, options: comboOptions },
  { id: "lunch-chicken-beef-szechuan", number: "L15", name: "Chicken or Beef Szechuan Style", category: "Lunch Special", spicy: true, description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 9.75 }, options: comboOptions },
  { id: "lunch-sesame-chicken", number: "L16", name: "Sesame Chicken", category: "Lunch Special", description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 9.75 }, options: comboOptions },
  { id: "lunch-teriyaki-chicken-vegetable", number: "L17", name: "Teriyaki Chicken with Vegetable", category: "Lunch Special", description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 9.45 }, options: comboOptions },
  { id: "lunch-teriyaki-beef-vegetable", number: "L17a", name: "Teriyaki Beef with Vegetable", category: "Lunch Special", description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 9.75 }, options: comboOptions },
  { id: "lunch-shrimp-chinese-vegetables", number: "L18", name: "Shrimp with Chinese Vegetables", category: "Lunch Special", description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 10.25 }, options: comboOptions },
  { id: "lunch-shrimp-mixed-vegetables", number: "L19", name: "Shrimp with Mixed Vegetables", category: "Lunch Special", description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 10.25 }, options: comboOptions },
  { id: "lunch-general-tsos-chicken", number: "L20", name: "General Tso's Chicken", category: "Lunch Special", spicy: true, description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 9.75 }, options: comboOptions },
  { id: "lunch-shrimp-broccoli-alt", number: "L21", name: "Shrimp with Broccoli", category: "Lunch Special", description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 9.75 }, options: comboOptions },
  { id: "lunch-sauteed-mixed-vegetables", number: "L22", name: "Sauteed Mixed Vegetables", category: "Lunch Special", description: "Served with pork fried rice. Choice of soup or soda.", prices: { order: 9.45 }, options: comboOptions },
