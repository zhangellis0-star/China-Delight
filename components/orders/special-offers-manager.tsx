        ...
        {offers.map((offer) => (
          <div key={offer.id} className="grid gap-2 rounded-md border border-china-gold/50 bg-white p-3 sm:grid-cols-[1fr_auto] sm:items-center">
            <div className="min-w-0">
              ...
              <p className="mt-0.5 text-sm font-bold text-stone-700">{offerSummary(offer)}</p>
            </div>
            <div className="flex flex-wrap gap-2 sm:justify-end">
              ...
              <button onClick={() => deleteOffer(offer)} className="focus-ring inline-flex min-h-9 items-center gap-1 rounded-md border border-red-200 bg-white px-3 text-sm font-black text-china-red">
