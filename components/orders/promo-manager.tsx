...
export function PromoManager() {
  ...
  return (
    <div id="admin-promo" className="mt-6 scroll-mt-24 rounded-lg border border-china-gold/60 bg-[#fff7e8] p-4 shadow-sm">
      ...
      <p className="mt-1 text-sm font-bold text-stone-600">Create discount or store-credit codes customers can apply at checkout.</p>
      ...
      <div className="mt-4 grid gap-2">
        {promoCodes.length === 0 && !loading && <p className="rounded-md border border-china-gold/60 bg-white p-4 text-center font-bold text-stone-600">No promo codes yet.</p>}
